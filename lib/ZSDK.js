...
var ZSDKMessageManager = (function(ZSDKMessageManager) {
  ...
  var AllowedOrigins = new RegExp("^https?:\/\/[a-zA-Z0-9-_]*.(sandbox.ucrm.com|sandbox.localzoho.com|csez.zohocorpin.com|zoho.com|localzoho.com|zohoplatform.com|localzohoplatform.com|zohosandbox.com|localzohosandbox.com)(:[0-9]{0,4})?$");
  ...
  function RegisterApp() {
    ...
    var registerSDKClient = {
      type: 'SDK.EVENT',
      eventName: 'REGISTER',
      appOrigin: encodeURIComponent(window.location.href)
    };

    // Initiating the Client Handshake
    window.top.postMessage(registerSDKClient, SDKContext.QueryParams.serviceOrigin);
  }
  ...
  function PostMessage(data) {
    ...
    if( typeof data === 'object' ) {
      data['appOrigin'] = encodeURIComponent(window.location.href);
    }
