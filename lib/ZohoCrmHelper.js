...
var ZOHO = (function() {
    ...
    return {
        ...
        CRM: (function() {
            ...
            function uploadMailAttachment(data)
            {
                if(data.File instanceof File)
                {
                    var newFile = createNewFileObj(data.File);
                    var data = {
                        FileData : newFile,
                        category : "MAIL",
                        type : "UPLOAD",
            ...
            return {
                ...
                API: {
                    ...
                    */
                     ...
                     *           "scheduled_time":"2018-06-12T12:12:12+05:30",
                     *           "template_id":"1230000673432543545446",
                     *           "attachments": [ { "id" : "encrypted_id" , "file_name" : "test"
                     *           "service_name" : "zohodocs/google_drive/documents"} ] ,
                     *           "org_email":true/false,
                     *           "consent_email":true/false,
                     *           "in_reply_to" : "123456" ,
                     *           "layout_id" : "1234567654343233223",
                     *           "paper_type" : "USLetter/default/A4" ,
                     *           "view_type" : "landscape/portrait",
                     *           "layout_name" : "QT_layout",
                     *           "data_subject_request" : {
                     *           "id" : "32323232332",
                     *           "type" : "access|export|rectify"
                     *           }
                     *       }
                     *   ]
                     *}
                     ...
                     * @memberof ZOHO.CRM.API
                     * @description upload file and use the fileid to attach with email
                     * @param {Object} config - Configuration Object.
                     * @param {File} File -  file
                     * @param {String} inline - should be  true for inline attachment 
                     * @returns {Promise} Resolved with uploaded file id
                     * @example
                     * Example 1:
                     * var file = document.getElementById("attachmentinput").files[0];
                     * var config={File:file}
                     * ZOHO.CRM.API.uploadMailAttachment(config).then(function(file){
                     *      console.log(data);
                     * });
                     * @example
                     * Exambple 2:
                     * var file = document.getElementById("attachmentinput").files[0];
                     * var config={File:file,inline:true}
                     * ZOHO.CRM.API.uploadMailAttachment(config).then(function(file){
                     *      console.log(data);
                     * });
                     *
                     * //prints
                     *{
                     *  "data":"bc719e4819e48c3b0e7ccd98153085a48293b357fbdc7a2ba58337642d6048f6bf90aa8ccf10c29026abbc18d0b6506b9adf5e5379a72689b0f3d1b612ad0080"
                     *}
                     *
                     *
                     */
                    uploadMailAttachment: function(data) {
                        return uploadMailAttachment(data);
                    },
