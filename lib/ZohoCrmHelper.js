    ...
    return {
        ...
        CRM: (function() {
            ...
            function remoteCall(method, requestData, type) {
                ...
                if (type != "CONNECTOR" && type!="CONNECTOR_API" && type!="CONNECTOR_REVOKE" && type!="CONNECTOR_AUTHORIZE") {
            ...
            return {
                ...
                API: {
                    ...
                    upsertRecord: function(data) {
                        ...
                        var APIData = data.APIData;
                        APIData.trigger = data.trigger;
                        APIData.actionType = "UPSERT";
                        APIData.duplicate_check_fields = data.duplicate_check_fields;
                        return createRecord(Entity, APIData);
                    },
                    /**
                     * @function getRecord
                ...
                CONNECTOR: {
                     ...
                     * @description Invokes Connector  
                     * @returns {Promise} resolved with response of the Connector 
                     * @memberof ZOHO.CRM.CONNECTOR
                     * @param {String} nameSpace - NameSpace of Connector to authorize
                     * @example
                     *   ZOHO.CRM.CONNECTOR.authorizeConnector("zoho.accounts");
                     *
                     */
                    authorizeConnector: function(nameSpace) {
