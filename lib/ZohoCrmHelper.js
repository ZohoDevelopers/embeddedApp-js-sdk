		...
		CRM : (function(){
			...
			return{
				...
				FUNCTIONS : {
                    ...
                    * }
                    */
					execute : function(cf_Name, reqData){
						var request = {};
						request.data = reqData.PARAMS;
						var data = {
								category : "FUNCTIONS_EXECUTE",//no i18n
								customFunctionName:cf_Name,
								data : request
							};
							return newRequestPromise(data);
					}
				...
				UI:
				{
					...
					/**
					 * @function Resize
					 * @description Resize Widget to the given dimensions. Requires JQuery.
				...
				CONNECTION:{
                    ...
                    *  }
                    */
					invoke:function(connectionName, reqData){	
						var request = {};
						var reqObj = {};
						reqObj.url = reqData.PARAMS.url;
						reqObj.method = reqData.PARAMS.method;
                        reqObj.param_type = reqData.PARAMS.param_type;
						reqObj.parameters = JSON.stringify(reqData.PARAMS.parameters);
						reqObj.headers = JSON.stringify(reqData.PARAMS.headers);
						request.data = reqObj;
						var data = {
