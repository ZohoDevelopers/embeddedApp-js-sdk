...
var ZOHO = (function() {
    ...
    return {
        ...
        CRM: (function() {
            ...
            function searchRecord(Entity, Type, Query, page, per_page,search) {
                var data = {
            ...
            function remoteCall(method, requestData, type) {
                ...
                if (type != "CONNECTOR") {
                    ...
                    var resultType = requestData.RESULT_TYPE;
                ...
                API: {
                    ...
                    */
                    ...
                    searchRecord: function(data) {
                        ...
                        return searchRecord(Entity, Type, Query, page, per_page,search);
                    },
                    /**
