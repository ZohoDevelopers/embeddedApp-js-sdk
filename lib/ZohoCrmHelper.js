...
(function (global) {
                ...
                getInput: async function (options, heading, accept_message, reject_message) {
                    if (options) {
                        if (!Array.isArray(options)) {
                            ...
                            throw new Error('options cannot be an empty array'); // no i18n
                        }
                            ...
                            options.forEach(option => {
                                ...
                                if (default_value) {
                                    ...
                                    } else if(type === 'number' && (typeof default_value != 'number' || !isNaN(default_value))){
                                        throw new TypeError(`default_value must be an number for number field type: ${default_value}`);
    ...
    var $Client = (function () {
        return {
            /**
             * @description Close the Widget as rendered progrmatically through openPopup/Flyout.
             * @memberof $Client
             * @function
             * @param {Any} [response] - response to be passed to the widget opened source
             * @example <caption>Sample</caption>
