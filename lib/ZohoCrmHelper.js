...
ZOHO.CRM=(function(){
	...
	{
		return ZOHO.embeddedApp.request(data)
	}
	...
	return{
		...
		CONFIG:{
			...
			getCurrentUser: function(){
				return config("CURRENT_USER").then(function(data){
					return data[0];
				});
			},
		},
		...
		API:{
			...
			* })
			* @example
			* ZOHO.CRM.API.searchRecord({Entity:"Leads",Type:"email",email:"svembu@zohocorp.com"})
			* .then(function(data){
			*     console.log(data)
			* })
			* 
