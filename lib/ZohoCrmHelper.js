            ...
            return {
                ...
                API: {
                    ...
                    **/
                    ...
                    /**
                    *Get the specific role by given unique ID
                    **/
                ...
                UI: {
                    ...
                    Setting: {
                         ...
                         * @param {String} data.webTabMessage - webTabMessage to pass as onload data
                         * @returns {Promise} resolved with true | false
                         * @memberof ZOHO.CRM.UI.Setting
                         * @example
                         * ZOHO.CRM.UI.Setting.open({"APIName": "widgetname__settingname","webTabMessage":{"fname":"xxxx","lname":"yyyy"})
                         * .then(function(data){
                         *     console.log(data)
                         * })
                         */
