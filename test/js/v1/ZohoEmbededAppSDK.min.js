...
l=b.origin;h=a.isAppRegistered()&&q===n&&r===l?!0:Error("Un-Authorized Message.")}if(h)switch(f){case "FRAMEWORK.EVENT":var A={SET_CONTEXT:e,UPDATE_CONTEXT:g,EVENT_RESPONSE:d,EVENT_RESPONSE_FAILURE:m}[c.eventName];A&&"function"===typeof A?A(b,c):ZSDKEventManager.NotifyEventListeners(a.AppContext,c.eventName,c.data);break;default:a.MessageInterceptor(b,c)}}catch(B){u.Error("[SDK.MessageHandler] \x3d\x3e ",B.stack)}}function e(b,c){q=window.parent;r=a.QueryParams.serviceOrigin;a.SetContext(c.data);
...
typeof ZSDKModelManager){for(var c in b)ZSDKModelManager.AddModel(c,b[c]);l.Model=ZSDKModelManager.GetModelStore()}w=a.uniqueID;r=a.connectors;x.Info("App Connectors ",r);z=!0}function m(){return w}function c(a){}function y(){return r}function n(a){k("/app-translations/"+a+".json",function(a){p=JSON.parse(a);v()})}function k(a,b){var c=new XMLHttpRequest;c.open("GET",a,!1);c.onreadystatechange=function(){4==c.readyState&&"200"==c.status&&b(c.responseText)};c.send(null)}function a(a,b,c){for(var d=
"";d!=a;)d=a,a=a.replace(b,c);return a}function u(a,b){b=b.replace(/\[(\w+)\]/g,".$1");b=b.replace(/^\./,"");for(var c=b.split("."),d=0,e=c.length;d<e;++d){var f=c[d];if(f in a)a=a[f];else return}return a}function v(){var b=document.querySelectorAll("[data-i18n]"),c;for(c in b)if(b.hasOwnProperty(c)){var d=u(p,b[c].getAttribute("data-i18n"));if(!d)return!1;if(b[c].hasAttribute("data-options")){var e=JSON.parse(JSON.stringify(eval("("+b[c].getAttribute("data-options")+")"))),f=Object.keys(e),g;for(g in f)d=
a(d,"${"+f[g]+"}",e[f[g]])}b[c].innerHTML=d}}var h,q,r,t,w,p={},x=ZSDKUtil.getLogger(),z=!1,C=!1;this.isContextReady=!1;this.HelperContext={};this.isDevMode=!1;this.getContext=function(){return l};var l={Model:{},Event:{}};l.Event.Listen=function(a,b){ZSDKEventManager.AttachEventListener(a,b)};l.Event.Trigger=g;l.GetRequest=function(a){return ZSDKMessageManager.SendRequest(a)};l.QueryParams=t;l.Translate=function(b,c){var d="";b&&(d=u(p,b));if(!d)return!1;if(c){var e=JSON.parse(JSON.stringify(eval(c))),
f=Object.keys(e);for(b in f)d=a(d,"${"+f[b]+"}",e[f[b]])}return d};this.OnLoad=function(a){if("function"!==typeof a)throw Error("Invalid Function value is passed");h=a;z&&b()};this.OnUnLoad=function(a){};this.OnContextUpdate=function(a){q=a};(function(){t=ZSDKUtil.GetQueryParams();isDevMode=!!t.isDevMode;var a={};a.isDevMode=isDevMode;a.ExecuteLoadHandler=b;a.SetContext=d;a.UpdateContext=c;a.QueryParams=t;a.GetConnectors=y;a.TriggerEvent=g;a.ExecuteContextUpdateHandler=f;a.getUniqueID=m;a.isAppRegistered=
